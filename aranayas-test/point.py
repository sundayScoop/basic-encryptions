...
class Point:
    ...
    def __add__(self, other):
        ...
        if isinstance(other, Point):
            new_point.x = pow(1 + self.d*self.x*other.x*self.y*other.y, -1, self.m)
            new_point.x = ((self.x*other.y + self.y*other.x) * pow(1 + self.d*self.x*other.x*self.y*other.y, -1, self.m))
